...
class AccidentalExposureViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
   ...
   @objc func addExposure() {
       ...
       newExposure.setValue(child, forKey: "child")
   ...
   func loadExposureHistory() {
       ...
       do {
           ...
           for exposure in exposureHistory {
               if let date = exposure.value(forKey: "date") as? Date,
                  ...
                  let desc = exposure.value(forKey: "desc") as? String {
                   ...
                   print("Exposure: \(dateString) - \(item) - \(desc)")
               }
           }
       } catch {
   ...
   func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       let isExpanded = expandedIndexSet.contains(indexPath)
       cell.configure(with: exposure, isExpanded: isExpanded)
       return cell
   }
